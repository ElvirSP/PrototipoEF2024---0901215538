...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2024 a las 06:53:12
...
(200, 1, 1000, '2024-11-08', '12:57:44', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(201, 1, 1000, '2024-11-08', '12:59:30', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(202, 1, 1000, '2024-11-08', '13:02:17', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(203, 1, 1000, '2024-11-08', '14:42:59', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(204, 1, 1000, '2024-11-08', '18:12:20', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(205, 1, 1000, '2024-11-08', '18:30:37', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(206, 1, 1000, '2024-11-08', '19:07:31', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(207, 1, 1000, '2024-11-08', '19:10:07', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(208, 1, 1000, '2024-11-08', '19:15:35', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(209, 1, 1000, '2024-11-08', '19:31:40', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(210, 1, 1000, '2024-11-08', '19:33:12', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(211, 1, 1000, '2024-11-08', '19:36:33', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(212, 1, 1000, '2024-11-08', '19:50:10', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(213, 1, 1000, '2024-11-08', '19:56:28', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(214, 1, 1000, '2024-11-08', '20:03:59', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(215, 1, 1000, '2024-11-08', '21:07:52', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(216, 1, 1000, '2024-11-08', '21:35:58', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(217, 1, 1000, '2024-11-08', '22:00:31', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login'),
(218, 1, 1000, '2024-11-08', '23:06:59', 'MSI', '192.168.1.138', 'Se logeo al sistema', 'Login');
...
--
-- Volcado de datos para la tabla `tbl_cobrador`
--

INSERT INTO `tbl_cobrador` (`Pk_id_cobrador`, `Fk_id_empleado`, `cobrador_nombre`, `cobrador_direccion`, `cobrador_telefono`, `cobrador_depto`, `estado`) VALUES
(1, 1, 'Pedro López', 'Av. Central, Ciudad', 5551234, 'Departamento 1', 1),
(2, 2, 'Sofía Martínez', 'Calle Principal, Ciudad', 5555678, 'Departamento 2', 1),
(3, 3, 'Carlos Ramírez', 'Zona Sur, Ciudad', 5559876, 'Departamento 3', 0);
...
INSERT INTO `tbl_proveedores` (`Pk_prov_id`, `Prov_nombre`, `Prov_direccion`, `Prov_telefono`, `Prov_email`, `Prov_fechaRegistro`, `estado`, `Proveedor_deuda`) VALUES
(1, 'Proveedor A', '123 Calle Principal, Ciudad A', '1234567890', 'contacto@proveedora.com', '2023-01-15', 1, 5000.75),
(2, 'Proveedor B', '456 Calle Secundaria, Ciudad B', '0987654321', 'info@proveedorb.com', '2023-03-10', 1, 3200.00),
(3, 'Proveedor C', '789 Avenida Tercera, Ciudad C', '1122334455', 'ventas@proveedorc.com', '2023-05-25', 0, 0.00),
(4, 'Proveedor D', '321 Avenida Cuarta, Ciudad D', '6677889900', 'soporte@proveedord.com', '2023-07-12', 1, 1500.50),
(5, 'Proveedor E', '654 Calle Quinta, Ciudad E', '5544332211', 'contacto@proveedore.com', '2023-09-30', 0, 0.00),
(6, 'Proveedor F', '987 Calle Sexta, Ciudad F', '4433221100', 'info@proveedorf.com', '2023-10-05', 1, 2750.20),
(7, 'Proveedor G', '123 Calle Séptima, Ciudad G', '3344556677', 'ventas@proveedorg.com', '2023-10-20', 1, 0.00);
...
(1, 'Depósito', 'Crédito', 1),
(2, 'Pago con Tarjeta de Credito', 'Débito', 1),
(3, 'Transferencia Bancaria', 'Débito', 1),
(4, 'Pago con Tarjeta de Débito', 'Débito', 1);
...
--
-- Volcado de datos para la tabla `tbl_transaccion_proveedor`
--

INSERT INTO `tbl_transaccion_proveedor` (`Pk_id_transaccion`, `Fk_id_proveedor`, `fecha_transaccion`, `transaccion_monto`, `transaccion_tipo_moneda`, `transaccion_estado`, `Fk_id_transC`, `transaccion_tipo`) VALUES
(1, 1, '08/11/2024', 1500.00, 'GTQ', 1, 1, 'Credito'),
(2, 2, '10/12/2024', 2000.00, 'USD', 1, 1, 'Credito'),
(4, 1, '14/02/2022', 20000.00, 'USD', 0, 3, 'Debito'),
(5, 2, '20/04/2024', 1800.00, 'GTQ', 1, 3, 'Debito');
...
(1, 'admin', 'admin', 'admin', '52c88f064ed5ed9161d01f634f5e3bfcf5c77fec94fb398b6690e1b41178eb6c', 'esduardo@gmail.com', '2024-11-08 23:06:59', 1, 'COLOR FAVORITO', 'ROJO');
...
--
ALTER TABLE `tbl_bitacora`
  MODIFY `Pk_id_bitacora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=219;
...
--
ALTER TABLE `tbl_cobrador`
  MODIFY `Pk_id_cobrador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_transaccion_cuentas`
  MODIFY `Pk_id_tran_cue` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `tbl_transaccion_proveedor`
--
ALTER TABLE `tbl_transaccion_proveedor`
  MODIFY `Pk_id_transaccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
